...
class ClothLikeAdapter(private val clothList: ArrayList<ClothesHardcodingItem>) : RecyclerView.Adapter<ClothLikeAdapter.CustomViewHolder>(){


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.activity_item_cloth_like, parent, false)
 ...
 */
        holder.checkLike.setButtonDrawable(R.drawable.selector_btnlike_24)
        holder.checkLike.isChecked=true
    ...
    class CustomViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView) {
        ...
        val checkLike : CheckBox = itemView.findViewById<CheckBox>(R.id.checkLike)
    }
}
