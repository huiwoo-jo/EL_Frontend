...
import kr.project.dongyang.el.ibda.ibda_client.activity.LoginActivity
import kr.project.dongyang.el.ibda.ibda_client.activity.MainActivity
import kr.project.dongyang.el.ibda.ibda_client.databinding.ActivityAiRecommendBinding
    ...
    inner class ButtonListener(): View.OnClickListener {
        override fun onClick(v: View?) {
            ...
            when (v?.id) {
                R.id.btnBack -> {
                    //검색
                    intent= Intent(this@AI_RecommendActivity, MainActivity::class.java)
