...
import kr.project.dongyang.el.ibda.ibda_client.databinding.ActivityDetailClothesBinding
    ...
    inner class ButtonListener: View.OnClickListener {
        override fun onClick(v: View?) {
            ...
            when (v?.id) {
                ...
                R.id.btnBack -> {
                    // 메인 페이지
                    intent=Intent(this@ClothesDetailsActivity, MainActivity::class.java)
                }
                R.id.btnSearch -> {
