...
import graduation.project.dongyang.el.ibda.activity.AI_RecommendActivity
import graduation.project.dongyang.el.ibda.activity.LikeActivity
import graduation.project.dongyang.el.ibda.activity.SearchActivty
import graduation.project.dongyang.el.ibda.activity.ShopActivity
...
import kr.project.dongyang.el.ibda.ibda_client.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item?.itemId) {
            R.id.action_search -> {
                //검색
                intent= Intent(this@MainActivity, SearchActivty::class.java)
                startActivity(intent)
                finish()
            }
            R.id.action_like -> {
                //관심
                intent= Intent(this@MainActivity, LikeActivity::class.java)
                startActivity(intent)
                finish()
            }
            R.id.action_basket -> {
                // 장바구니
                intent= Intent(this@MainActivity, ShopActivity::class.java)
                startActivity(intent)
                finish()
            }
            R.id.action_power -> {
    ...
    inner class ButtonListener(): View.OnClickListener {
        override fun onClick(v: View?) {
            ...
            when (v?.id) {
                ...
                R.id.btnMainAI -> {
                    var intent = Intent(this@MainActivity, AI_RecommendActivity::class.java)
                    startActivity(intent)
                    finish()
                }
            }
